...
2. **Domain flexibility** - Subdomains (school.scholarly.io) or custom (www.brightongrammar.edu.au)
...
- Domain: `brightongrammar.scholarly.io` or `www.brightongrammar.edu.au`
- Type: `school`
...
- Domain: `sarahmaths.scholarly.io`
- Type: `solo_tutor`
...
- Domain: `forestlearning.scholarly.io`
- Type: `micro_school`
...
- Domain: `nrhomeschool.scholarly.io`
