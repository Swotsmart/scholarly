...
import { askIssyRouter } from './routes/ask-issy';
import { askIssyChatRouter } from './routes/ask-issy-chat';
...
api.use('/scheduling', authMiddleware, schedulingRouter);
api.use('/dashboard', authMiddleware, dashboardRouter);
api.use('/ask-issy', authMiddleware, askIssyRouter);
api.use('/ask-issy', authMiddleware, askIssyChatRouter);
