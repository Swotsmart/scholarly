    ...
    const plans = [
      {
        ...
        features: [
          ...
          { key: 'ask_issy_messages', label: 'Ask Issy messages/month', value: 50 },
        ...
        entitlements: ['basic_curriculum', 'ask_issy_limited', 'portfolio_basic'],
        isPublic: true,
        trialDays: 0,
        tenantId,
      ...
      },
      {
        ...
        features: [
          ...
          { key: 'ask_issy_messages', label: 'Ask Issy messages/month', value: 500 },
        ...
        entitlements: [
          'full_curriculum', 'ask_issy_standard', 'portfolio_full',
      ...
      },
      {
        ...
        features: [
          ...
          { key: 'ask_issy_messages', label: 'Ask Issy messages/month', value: 'unlimited' },
        ...
        entitlements: [
          'full_curriculum', 'ask_issy_unlimited', 'portfolio_full',
  ...
  try {
    ...
    const planMap: Record<string, any> = {
      ...
      plan_family_au: {
        ...
        entitlements: ['full_curriculum', 'ask_issy_standard', 'homeschool_compliance'],
        isPublic: true,
        trialDays: 14,
        tenantId,
      },
...
subscriptionsRouter.get('/analytics', async (req, res) => {
  try {
    ...
    const analytics = {
      ...
      topFeatureUsage: [
        { feature: 'ask_issy', usagePercent: 89.2 },
