...
import { ScholarlyConfig } from './base.service';

// ============================================================================
// JURISDICTION & SAFEGUARDING TYPES (used by mesh-types)
// ============================================================================
...
export interface InterventionRecommendation {
  ...
  successMetrics: { metric: string; target: unknown }[];
