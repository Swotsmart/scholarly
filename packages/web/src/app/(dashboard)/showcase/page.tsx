...
import { useShowcaseDashboardLayout, type ShowcasePanelId } from '@/stores/dashboard-layout-store';
import {
  FolderOpen,
  TrendingUp,
  Eye,
...
function FeaturedPortfolioPanel() {
  return (
    <Card>
      <CardHeader>
...
const PANEL_MAP: Record<ShowcasePanelId, () => JSX.Element> = {
  'stats': StatsPanel,
  'featured-portfolio': FeaturedPortfolioPanel,
...
export default function ShowcasePage() {
  const { panelOrder, setPanelOrder } = useShowcaseDashboardLayout();
