...
const demoActivities: AdminActivity[] = [
  ...
  { id: 'a5', action: 'Feature Flag Toggled', description: 'Ask Alice chat enabled for Year 11-12 learners', user: 'Jack Williams', timestamp: '2026-01-25T16:50:00Z', type: 'config' },
];
...
const demoFeatureFlags: FeatureFlag[] = [
  { id: 'ff1', name: 'Ask Alice Chat', enabled: true, description: 'AI-powered learning assistant for student queries', scope: 'global' },
