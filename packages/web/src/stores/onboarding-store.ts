...
export const learnerOnboardingSteps: OnboardingStep[] = [
  ...
  { id: 'ai-buddy', title: 'Meet Ask Alice', description: 'Your personal learning assistant is ready to help with questions, explanations, and study tips.', icon: 'Bot', href: '/ai-buddy', estimatedMinutes: 2 },
