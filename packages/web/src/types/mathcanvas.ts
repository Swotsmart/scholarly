...
export type CanvasMode = 'graphing' | 'geometry' | '3d' | 'stats' | 'cas';
...
// Extended CanvasMode — add 'expression' for the P3 direct-input mode
// (CAS mode = AI-guided tasks; expression mode = free-form live input)
export type ExtCanvasMode = CanvasMode | 'expression';
